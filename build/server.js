...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _expressSession = __webpack_require__(85);
  ...
  var _pg = __webpack_require__(94);
  
  var _pg2 = _interopRequireDefault(_pg);
  
  var _connectPgSimple = __webpack_require__(80);
  
  var _connectPgSimple2 = _interopRequireDefault(_connectPgSimple);
  
  var _config = __webpack_require__(10);
  
  var _instagramNode = __webpack_require__(91);
  ...
  server.use((0, _expressSession2.default)({
    ...
    store: new PgSession({
      pg: _pg2.default,
      conString: _config.databaseUrl,
      tableName: 'session'
    })
  }));
  
  var instagramRedirectUri = 'http://' + _config.host + '/instagram';
  
  server.all('*', function (req, res, next) {
    var origin = req.protocol + '://' + _config.clientHost;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              sess.token = null;
              res.redirect('http://' + _config.clientHost);
  ...
  server.get('/instagram/status', function () {
  ...
  server.get('/instagram/media', function () {
      ...
      return _regenerator2.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              if (req.session.token) {
                api = (0, _instagramNode.instagram)({});
  
                api.use({ access_token: req.session.token });
  
                handler = function handler(err, medias, pagination, remaining, limit) {
                  if (err) {
                    res.status(400);
                  }
                  res.json(medias);
  ...
  server.get('/instagram/sign-in', function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              api.use({
                client_id: _config.auth.instagram.id,
                client_secret: _config.auth.instagram.secret
              });
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              api.authorize_user(req.query.code, instagramRedirectUri, function (err, result) {
                if (err) {
                  res.status(400);
                  res.json(err);
                } else {
...
/***/ function(module, exports, __webpack_require__) {
  ...
  exports.sessionSecret = exports.auth = exports.analytics = exports.databaseUrl = exports.clientHost = exports.clientPort = exports.host = exports.port = undefined;
  ...
  var port = exports.port = process.env.PORT || 3000; /* eslint-disable max-len */
  /* jscs:disable maximumLineLength */
  
  var host = exports.host = process.env.WEBSITE_HOSTNAME || 'localhost:' + port;
  
  var clientPort = exports.clientPort = process.env.PORT || 3001;
  var clientHost = exports.clientHost = process.env.WEBSITE_HOSTNAME || 'localhost:' + clientPort;
  
  var databaseUrl = exports.databaseUrl = process.env.DATABASE_URL || 'postgresql://' + process.env.USER + '@localhost:5432/catlister_development';
  ...
  var auth = exports.auth = {
    instagram: {
      id: process.env.INSTAGRAM_CLIENT_ID || _config2.default.instagram.id,
      secret: process.env.INSTAGRAM_CLIENT_SECRET || _config2.default.instagram.secret,
      url: 'https://api.instagram.com'
    }
  };
  
  var sessionSecret = exports.sessionSecret = process.env.SESSION_SECRET || _config2.default.sessionSecret;
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Instagram = function () {
    function Instagram() {
      ...
      this.url = 'http://' + _config.clientHost + '/instagram';
    ...
    (0, _createClass3.default)(Instagram, [{
      ...
      value: function json(path) {
        return (0, _fetch2.default)(this.url + '/' + path, this.opts).then(function (res) {
          return res.json();
        });
      }
    }]);
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { className: _Footer2.default.separator },
            '·'
          ),
          _react2.default.createElement(
            'a',
            { href: 'https://github.com/cheshire137/catlister', target: '_blank' },
            'View source'
          )
        )
      )
...
/***/ function(module, exports, __webpack_require__) {
  ...
  function Image(_ref) {
    ...
    var image = images.thumbnail;
    return _react2.default.createElement(
      'a',
      { href: link, target: '_blank', className: _Image2.default.image },
      _react2.default.createElement('img', { src: image.url, width: image.width, height: image.height })
    );
  }
  ...
  Image.propTypes = {
    ...
    created_time: _react.PropTypes.string,
    link: _react.PropTypes.string,
    likes: _react.PropTypes.object,
    images: _react.PropTypes.object,
    users_in_photo: _react.PropTypes.array,
    caption: _react.PropTypes.object,
    user_has_liked: _react.PropTypes.bool,
    id: _react.PropTypes.string,
    user: _react.PropTypes.object
  };
  
  exports.default = (0, _withStyles2.default)(Image, _Image2.default);
  ...
  var Navigation = function (_Component) {
    ...
    (0, _createClass3.default)(Navigation, [{
      ...
      value: function componentDidMount() {
        ...
        var ig = new _instagram2.default();
        ig.isAuthenticated().then(function (json) {
          _this2.setState({ isAuthenticated: json.isAuthenticated });
        });
      }
    }, {
      key: 'render',
      value: function render() {
        return _react2.default.createElement(
          ...
          this.state.isAuthenticated ? _react2.default.createElement(
            'a',
            { className: 'nav-item', href: '/logout' },
            'Log Out'
          ) : _react2.default.createElement(
            'a',
            { className: 'nav-item', href: '/instagram/sign-in' },
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Home = function (_Component) {
    ...
    function Home() {
      ...
      var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Home).call(this));
    ...
    (0, _createClass3.default)(Home, [{
      ...
      value: function componentDidMount() {
        ...
        var ig = new _instagram2.default();
        ig.getMedia('nashville').then(function (media) {
          var images = media.filter(function (i) {
            return i.type === 'image';
          });
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          'div',
          { className: 'container' },
          rows.map(function (images, index) {
            return _react2.default.createElement(
              'div',
              { key: index, className: 'columns' },
              images.map(function (image) {
                return _react2.default.createElement(
                  'div',
                  { className: 'column is-one-quarter', key: image.id },
                  _react2.default.createElement(_Image2.default, image)
                );
              })
            );
          })
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "/*\r\n * Colors\r\n * ========================================================================== */\r\n\r\n/* #222 */\r\n\r\n/* #404040 */\r\n\r\n/* #555 */\r\n\r\n/* #777 */\r\n\r\n/* #eee */\r\n\r\n/*\r\n * Typography\r\n * ========================================================================== */\r\n\r\n/*\r\n * Layout\r\n * ========================================================================== */\r\n\r\n/*\r\n * Media queries breakpoints\r\n * ========================================================================== */\r\n\r\n/* Extra small screen / phone */\r\n\r\n/* Small screen / tablet */\r\n\r\n/* Medium screen / desktop */\r\n\r\n/* Large screen / wide desktop */\r\n\r\n/*\r\n * Animations\r\n * ========================================================================== */\r\n\r\n.Footer_separator_3a2 {\r\n  display: inline-block;\r\n  margin: 0 1em;\r\n}\r\n", "", {"version":3,"sources":["/./src/components/variables.scss","/./src/components/Footer/Footer.scss"],"names":[],"mappings":"AAAA;;gFAEgF;;AAGxB,UAAU;;AACV,aAAa;;AACb,UAAU;;AACV,UAAU;;AACV,UAAU;;AAElE;;gFAEgF;;AAIhF;;gFAEgF;;AAIhF;;gFAEgF;;AAEhD,gCAAgC;;AAChC,2BAA2B;;AAC3B,6BAA6B;;AAC7B,iCAAiC;;AAEjE;;gFAEgF;;AChChF;EACE,sBAAsB;EACtB,cAAc;CACf","file":"Footer.scss","sourcesContent":["/*\r\n * Colors\r\n * ========================================================================== */\r\n\r\n$white-base:            hsl(255, 255, 255);\r\n$gray-darker:           color(black lightness(+13.5%)); /* #222 */\r\n$gray-dark:             color(black lightness(+25%));   /* #404040 */\r\n$gray:                  color(black lightness(+33.5%)); /* #555 */\r\n$gray-light:            color(black lightness(+46.7%)); /* #777 */\r\n$gray-lighter:          color(black lightness(+93.5%)); /* #eee */\r\n\r\n/*\r\n * Typography\r\n * ========================================================================== */\r\n\r\n$font-family-base:      'Segoe UI', 'HelveticaNeue-Light', sans-serif;\r\n\r\n/*\r\n * Layout\r\n * ========================================================================== */\r\n\r\n$max-content-width:     1000px;\r\n\r\n/*\r\n * Media queries breakpoints\r\n * ========================================================================== */\r\n\r\n$screen-xs-min:         480px;  /* Extra small screen / phone */\r\n$screen-sm-min:         768px;  /* Small screen / tablet */\r\n$screen-md-min:         992px;  /* Medium screen / desktop */\r\n$screen-lg-min:         1200px; /* Large screen / wide desktop */\r\n\r\n/*\r\n * Animations\r\n * ========================================================================== */\r\n\r\n$animation-swift-out:   .45s cubic-bezier(0.3, 1, 0.4, 1) 0s;\r\n","@import '../variables.scss';\r\n\r\n.separator {\r\n  display: inline-block;\r\n  margin: 0 1em;\r\n}\r\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "/*\r\n * Colors\r\n * ========================================================================== */\r\n\r\n/* #222 */\r\n\r\n/* #404040 */\r\n\r\n/* #555 */\r\n\r\n/* #777 */\r\n\r\n/* #eee */\r\n\r\n/*\r\n * Typography\r\n * ========================================================================== */\r\n\r\n/*\r\n * Layout\r\n * ========================================================================== */\r\n\r\n/*\r\n * Media queries breakpoints\r\n * ========================================================================== */\r\n\r\n/* Extra small screen / phone */\r\n\r\n/* Small screen / tablet */\r\n\r\n/* Medium screen / desktop */\r\n\r\n/* Large screen / wide desktop */\r\n\r\n/*\r\n * Animations\r\n * ========================================================================== */\r\n", "", {"version":3,"sources":["/./src/components/variables.scss"],"names":[],"mappings":"AAAA;;gFAEgF;;AAGxB,UAAU;;AACV,aAAa;;AACb,UAAU;;AACV,UAAU;;AACV,UAAU;;AAElE;;gFAEgF;;AAIhF;;gFAEgF;;AAIhF;;gFAEgF;;AAEhD,gCAAgC;;AAChC,2BAA2B;;AAC3B,6BAA6B;;AAC7B,iCAAiC;;AAEjE;;gFAEgF","file":"Header.scss","sourcesContent":["/*\r\n * Colors\r\n * ========================================================================== */\r\n\r\n$white-base:            hsl(255, 255, 255);\r\n$gray-darker:           color(black lightness(+13.5%)); /* #222 */\r\n$gray-dark:             color(black lightness(+25%));   /* #404040 */\r\n$gray:                  color(black lightness(+33.5%)); /* #555 */\r\n$gray-light:            color(black lightness(+46.7%)); /* #777 */\r\n$gray-lighter:          color(black lightness(+93.5%)); /* #eee */\r\n\r\n/*\r\n * Typography\r\n * ========================================================================== */\r\n\r\n$font-family-base:      'Segoe UI', 'HelveticaNeue-Light', sans-serif;\r\n\r\n/*\r\n * Layout\r\n * ========================================================================== */\r\n\r\n$max-content-width:     1000px;\r\n\r\n/*\r\n * Media queries breakpoints\r\n * ========================================================================== */\r\n\r\n$screen-xs-min:         480px;  /* Extra small screen / phone */\r\n$screen-sm-min:         768px;  /* Small screen / tablet */\r\n$screen-md-min:         992px;  /* Medium screen / desktop */\r\n$screen-lg-min:         1200px; /* Large screen / wide desktop */\r\n\r\n/*\r\n * Animations\r\n * ========================================================================== */\r\n\r\n$animation-swift-out:   .45s cubic-bezier(0.3, 1, 0.4, 1) 0s;\r\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"Image.scss","sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "/*\r\n * Colors\r\n * ========================================================================== */\r\n\r\n/* #222 */\r\n\r\n/* #404040 */\r\n\r\n/* #555 */\r\n\r\n/* #777 */\r\n\r\n/* #eee */\r\n\r\n/*\r\n * Typography\r\n * ========================================================================== */\r\n\r\n/*\r\n * Layout\r\n * ========================================================================== */\r\n\r\n/*\r\n * Media queries breakpoints\r\n * ========================================================================== */\r\n\r\n/* Extra small screen / phone */\r\n\r\n/* Small screen / tablet */\r\n\r\n/* Medium screen / desktop */\r\n\r\n/* Large screen / wide desktop */\r\n\r\n/*\r\n * Animations\r\n * ========================================================================== */\n", "", {"version":3,"sources":["/./src/components/variables.scss"],"names":[],"mappings":"AAAA;;gFAEgF;;AAGxB,UAAU;;AACV,aAAa;;AACb,UAAU;;AACV,UAAU;;AACV,UAAU;;AAElE;;gFAEgF;;AAIhF;;gFAEgF;;AAIhF;;gFAEgF;;AAEhD,gCAAgC;;AAChC,2BAA2B;;AAC3B,6BAA6B;;AAC7B,iCAAiC;;AAEjE;;gFAEgF","file":"Home.scss","sourcesContent":["/*\r\n * Colors\r\n * ========================================================================== */\r\n\r\n$white-base:            hsl(255, 255, 255);\r\n$gray-darker:           color(black lightness(+13.5%)); /* #222 */\r\n$gray-dark:             color(black lightness(+25%));   /* #404040 */\r\n$gray:                  color(black lightness(+33.5%)); /* #555 */\r\n$gray-light:            color(black lightness(+46.7%)); /* #777 */\r\n$gray-lighter:          color(black lightness(+93.5%)); /* #eee */\r\n\r\n/*\r\n * Typography\r\n * ========================================================================== */\r\n\r\n$font-family-base:      'Segoe UI', 'HelveticaNeue-Light', sans-serif;\r\n\r\n/*\r\n * Layout\r\n * ========================================================================== */\r\n\r\n$max-content-width:     1000px;\r\n\r\n/*\r\n * Media queries breakpoints\r\n * ========================================================================== */\r\n\r\n$screen-xs-min:         480px;  /* Extra small screen / phone */\r\n$screen-sm-min:         768px;  /* Small screen / tablet */\r\n$screen-md-min:         992px;  /* Medium screen / desktop */\r\n$screen-lg-min:         1200px; /* Large screen / wide desktop */\r\n\r\n/*\r\n * Animations\r\n * ========================================================================== */\r\n\r\n$animation-swift-out:   .45s cubic-bezier(0.3, 1, 0.4, 1) 0s;\r\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
      ...
      // Only activated in browser context
      if (false) {
        module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap&modules&localIdentName=[name]_[local]_[hash:base64:3]!./../../../node_modules/postcss-loader/index.js?parser=postcss-scss!./Image.scss", function() {
          var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap&modules&localIdentName=[name]_[local]_[hash:base64:3]!./../../../node_modules/postcss-loader/index.js?parser=postcss-scss!./Image.scss");
          if (typeof newContent === 'string') {
            newContent = [[module.id, content, '']];
          }
          removeCss = insertCss(newContent, { replace: true });
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var jade_debug = [ new jade.DebugItem( 1, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ) ];
  try {
  var buf = [];
  var jade_mixins = {};
  var jade_interp;
  ;var locals_for_with = (locals || {});(function (stack) {
  jade_debug.unshift(new jade.DebugItem( 0, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  jade_debug.unshift(new jade.DebugItem( 1, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<!DOCTYPE html>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 2, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<html lang=\"en\">");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 3, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<head>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 4, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<meta charset=\"utf-8\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 5, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<title>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  ...
  buf.push("</title>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 6, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 7, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<style>");
  ...
  buf.push("</head>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 59, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<body>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 60, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<h1>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  ...
  buf.push("</h1>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 61, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  buf.push("<p>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  ...
  buf.push("</p>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 62, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
  ...
  buf.push("</html>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 63, "/Users/cheshire137/code/cheshire137/catlister/src/views/error.jade" ));
...
/***/ function(module, exports, __webpack_require__) {
  ...
  module.exports = function template(locals) {
  var jade_debug = [ new jade.DebugItem( 1, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ) ];
  try {
  var buf = [];
  var jade_mixins = {};
  var jade_interp;
  ;var locals_for_with = (locals || {});(function (body, css, description, entry, title, trackingId) {
  jade_debug.unshift(new jade.DebugItem( 0, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  jade_debug.unshift(new jade.DebugItem( 1, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<!DOCTYPE html>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 2, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<html lang=\"\" class=\"no-js\">");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 3, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<head>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 4, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<meta charset=\"utf-8\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 5, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<meta http-equiv=\"x-ua-compatible\" content=\"ie=edge\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 6, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<title>" + (jade.escape(null == (jade_interp = title) ? "" : jade_interp)));
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.shift();
  buf.push("</title>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 7, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<meta name=\"description\"" + (jade.attr("description", description, true, true)) + ">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 8, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 9, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/bulma/0.1.0/css/bulma.min.css\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 10, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<link rel=\"apple-touch-icon\" href=\"apple-touch-icon.png\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 11, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  ...
  buf.push("</head>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 12, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<body>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 13, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<div id=\"app\">" + (null == (jade_interp = body) ? "" : jade_interp));
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.shift();
  buf.push("</div>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 14, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<script" + (jade.attr("src", entry, true, true)) + ">");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.shift();
  buf.push("</script>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 15, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  buf.push("<script>");
  ...
  buf.push("</script>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 18, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  if ( trackingId)
  {
  jade_debug.unshift(new jade.DebugItem( 19, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
  jade_debug.unshift(new jade.DebugItem( 19, "/Users/cheshire137/code/cheshire137/catlister/src/views/index.jade" ));
...
/***/ function(module, exports) {
  ...
  module.exports = {
  	"instagram": {
  		"id": "e305f00339c84c60abddf7f030d0193d",
  		"secret": "9f9141f1901d452ba7fdb8e5696c8032"
  	},
  	"sessionSecret": "0iXcsnVNSTC20E96150B9GC33kTI3Pgu"
  };
